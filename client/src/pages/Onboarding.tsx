import { ArrowLeft, ArrowRight, PersonStanding, ScaleIcon, TargetIcon, UserIcon } from "lucide-react";
    ...
    <div className="onboarding-container">
      ...
      <div className="p-6 pt-12 onboarding-wrapper">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-slate-800 dark:text-white">FitSync</h1>
        </div>
        ...
        {step===1 && (
          <div className="space-y-6">
            <div className="flex items-center gap-4 mb-8">
              ...
              <UserIcon className="size-6 text-emerald-600 dark:text-emerald-400"/></div>
              <div>
        ...
        {step===2 && (
          ...
          <div className="space-y-6 onboarding-wrapper">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 border-emerald-100 dark:border-emerald-800 flex items-center justify-center">
              <TargetIcon className="size-6 text-emerald-600 dark:text-emerald-400"/></div>
              <div>
